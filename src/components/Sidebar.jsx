...
//             <Link to="/" onClick={() => setOpenSidebar(false)}>  <div className="flex justify-center mb-8">
...
//                             className={`block p-3 rounded-md ${activeLink === 'dashboard' ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
//                         >
//                             Dashboard
//                         </Link>
//                     </li>
...
//                             className={`block p-3 rounded-md ${activeLink === 'userdetails' ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
//                         >
//                             User Details
//                         </Link>
//                     </li>
...
//                             onClick={() => handleClick('servicemanagement')}
//                             className={`block p-3 rounded-md ${activeLink === 'servicemanagement' ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
//                         >
//                             Service Management
//                         </Link>
//                     </li>
...
//                             className={`block p-3 rounded-md ${activeLink === 'order' ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
//                         >
//                             Order
//                         </Link>
//                     </li>
...
//                             className={`block p-3 rounded-md ${activeLink === 'coupon' ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
//                         >
//                             Coupons
//                         </Link>
//                     </li>
                ...
                <ul className="flex flex-col gap-4 md:px-5">
                    ...
                    <li>
                        <Link
                            to="/order"
                            onClick={() => setOpenSidebar(false)}
                            className={`block p-3 rounded-md ${location.pathname === '/order' ? 'bg-gray-600' : 'hover:bg-gray-700'}`}
                        >
                            Order
                        </Link>
                    </li>
