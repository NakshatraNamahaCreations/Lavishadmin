...
//   const [showOrderDropdown, setShowOrderDropdown] = useState(false); // State for Order Details dropdown
//   const [showSettingsDropdown, setShowSettingsDropdown] = useState(false); // State for Order Details dropdown
...
//             <Link
//               to="/"
//               className={`block px-3 py-2 rounded-md ${isActive("/") ? "bg-gray-600" : "hover:bg-gray-700"
//                 }`}
//             >
//               Dashboard
//             </Link>
...
//             <Link
//               to="/banner"
//               className={`block px-3 py-2 rounded-md ${location.pathname === "/banner"
//                 ? "bg-gray-600"
//                 : "hover:bg-gray-700"
//                 }`}
//             >
...
//               className="flex justify-between items-center cursor-pointer px-3 py-2 rounded-md hover:bg-gray-700"
//             >
...
//                 <li>
//                   <Link
//                     to="/catgory/add_category"
//                     className={`block px-3 py-2 rounded-md ${isActive("/catgory/add_category")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/catgory/add_subcategory"
//                     className={`block px-3 py-2 rounded-md ${isActive("/catgory/add_subcategory")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/catgory/add_sub_subcategory"
//                     className={`block px-3 py-2 rounded-md ${isActive("/catgory/add_sub_subcategory")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/catgory/add_theme"
//                     className={`block px-3 py-2 rounded-md ${isActive("/catgory/add_theme")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/catgory/add_balloonColor"
//                     className={`block px-3 py-2 rounded-md ${isActive("/catgory/add_balloonColor")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                     className={`block px-3 py-2 rounded-md ${isActive("/service/service-list")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/addons/addons-list"
//                     className={`block px-3 py-2 rounded-md ${isActive("/addons/addons-list")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                     to="/coupon"
//                     onClick={() => setOpenSidebar(false)}
//                     className={`block px-3 py-2 rounded-md ${location.pathname === "/coupon"
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     // to="/orderdetails/booking-details"
//                     to="/orderdetails/calender"
//                     className={`block px-3 py-2 rounded-md ${isActive("/orderdetails/booking-details")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/orderdetails/cancelled-bookings"
//                     className={`block px-3 py-2 rounded-md ${isActive("/orderdetails/cancelled-bookings")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/orderdetails/rescheduled-bookings"
//                     className={`block px-3 py-2 rounded-md ${isActive("/orderdetails/rescheduled-bookings")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//                 <li>
//                   <Link
//                     to="/orderdetails/completed-bookings"
//                     className={`block px-3 py-2 rounded-md ${isActive("/orderdetails/completed-bookings")
//                       ? "bg-gray-600"
//                       : "hover:bg-gray-700"
//                       }`}
//                   >
...
//             <Link
//               to="/payment-details"
//               className={`block px-3 py-2 rounded-md ${isActive("/payment-details") ? "bg-gray-600" : "hover:bg-gray-700"
//                 }`}
//             >
//               Payment Details
//             </Link>
...
//             <Link
//               to="/report"
//               className={`block px-3 py-2 rounded-md ${isActive("/report") ? "bg-gray-600" : "hover:bg-gray-700"
//                 }`}
//             >
//               Reports
//             </Link>
...
//             <Link
//               to="/settings/teams"
//               className={`block px-3 py-2 rounded-md ${isActive("/settings/teams")
//                 ? "bg-gray-600"
//                 : "hover:bg-gray-700"
//                 }`}
//             >
