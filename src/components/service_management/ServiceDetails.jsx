...
//   if (!service) {
//     return <div className="text-center mt-20 text-gray-500 text-lg">No service found.</div>;
//   }

//   return (
//     <div className="min-h-screen bg-gray-100 py-2 px-4 md:px-10">
//       <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-lg p-8 relative">
//         {/* <button
//           onClick={() => navigate(-1)}
//           className="absolute top-4 right-4 bg-blue-600 text-white text-sm px-3 py-1 rounded hover:bg-blue-700 transition"
//         >
//           ← Back
//         </button> */}
...
//           <Detail label="Service Name" value={service.serviceName} />
...
//           <Detail
//             label="Offer Price"
//             value={`₹${service.offerPrice}`}
//           />
//           <Detail
//             label="Balloon Colors"
//             value={
//               service.balloonColors.length > 0
//                 ? service.balloonColors.join(", ")
//                 : "N/A"
//             }
//           />
//           <Detail
